...
const AdminVenueForm = ({ venue, onSave, onCancel }) => {
    ...
    if (!formData.latitude || !formData.longitude) {
      setErrors({
        ...
        latitude: !formData.latitude
          ? "Широта обязательна для генерации виджета"
          : null,
        longitude: !formData.longitude
          ? "Долгота обязательна для генерации виджета"
          : null,
      });
      return;
    }
  ...
  const validateForm = () => {
    ...
    if (
      ...
      newErrors.latitude = t("admin.venues.validation.latitudeInvalid");
    }
    ...
    if (
      ...
      newErrors.longitude = t("admin.venues.validation.longitudeInvalid");
    }
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-row">
          ...
          <div className="form-group widget-generator">
            <label>{t("admin.venues.mapWidget")}</label>
            <button
              type="button"
        ...
        <div className="form-group">
          <label htmlFor="map_widget_code">{t("admin.venues.mapWidget")}</label>
          <textarea
            id="map_widget_code"
          ...
          <div className="widget-help-text">
            Для генерации кода виджета введите широту и долготу, затем нажмите
            "Сгенерировать виджет карты"
          </div>
        </div>
        ...
        {showWidgetPreview && formData.map_widget_code && (
          <div className="form-group">
            ...
            <div className="widget-preview">
              <div
                dangerouslySetInnerHTML={{ __html: formData.map_widget_code }}
              />
            </div>
          </div>
        )}
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Подробное описание спортивного объекта..."
          ></textarea>
        </div>
